...
게임이 시작되면 화면에는 카드 16장이 뒷면을 위로하여 4 x 4 크기의 격자 형태로 표시되어 있습니다. 각 카드의 앞면에는 카카오프렌즈 캐릭터 그림이 그려져 있으며, 
...
if __name__ == "__main__":
    ...
    for b, r, c, rst in zip(board, R, C, result):
        print(solution(b, r, c) == rst)